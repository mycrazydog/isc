...
class LicenseController extends BaseController
{
    ...
    public function getIndex()
    {
        ...
        $licenses = $this->license->with(array(
            'author' => function ($query) {
                $query->withTrashed();
            },
        ))->orderBy('created_at', 'DESC')->paginate();
        
        return View::make('backend/licenses/directory')->with('licenses', $licenses);
     ...
     */
    public function getView($license_id)
    {
        // Get this blog post data
        $license = $this->license->with(array(
            'author' => function ($query) {
                $query->withTrashed();
            },
            
        ))->where('id', $license_id)->first();
        ...
        // Show the page
        return View::make('backend/licenses/view-license', compact('license'));
    }
